const images = [
 ...
 const listLinc = document.querySelector('.gallery')
const fullString = images.reduce((accString, {url,alt}) => {
  const protoString = `<li><img src="${url}" alt="${alt}"></li>`
  return accString + protoString
}, '') 
 
listLinc.insertAdjacentHTML("beforeend", fullString)
